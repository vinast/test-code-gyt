...
const { getTransaksi, deleteTransaksi, konfirmasiAdmin, konfirmasiUser, createTransaksi, getTransaksiById, getTransaksibyUser, getJumlahTransaksi }= require( "../controllers/Transaksi.js")
...
router.get('/transaksicount', getJumlahTransaksi);
